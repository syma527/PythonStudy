...
6、创建订单
Request URL: http://mall.lemonban.com:8107/p/seckill/3BURR4Ezk1N/confirm
Request Method: POST
Content-Type: application/json; charset=UTF-8
{
  "addrId": 0,
...
7、提交订单
Request URL: http://mall.lemonban.com:8107/p/seckill/3BUSiAiPRFe/submit
Request Method: POST
Content-Type: application/json; charset=UTF-8
{
  "orderShopParam": {
...
{
  "payType": 3,
  "orderNumbers": "1559151086630342656"
}
...
Content-Type: application/json; charset=UTF-8
{
"payNo":self.order_number, #商城支付订单号
