...
class BasePage:
    ...
    def __wait_elements_located(self,locations,page_action):
        #只要加载到dom树中就可以，不一定可见
    ...
    #获取多个元素，返回list
    def find_more_element(self,locations, page_action):
        elements = self.__wait_elements_located(locations=locations, page_action=page_action)
        return elements
