...
from ddt import ddt,data
test_data = [
             {"method":"post","title":"登陆成功1","url":"http://www.lemon.com/login1"},
             {"method":"get","title":"登陆成功2","url":"http://www.lemon.com/login2"},
             {"method":"patch","title":"登陆成功3","url":"http://www.lemon.com/login3"}
             ]
@ddt
